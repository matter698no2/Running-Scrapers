...
#Depreciated, all info that was on this one can now be found in the runner_info file
...
#call the function
scraped_data = ms.meet_data_scraper('https://www.athletic.net/CrossCountry/Results/Meet.aspx?Meet=143681')
ms.write_to_csv(scraped_data, 5000, 'wb', meet, runners)
...
for year_url in urls:
	...
	scraped_data = ms.meet_data_scraper(url)
	ms.write_to_csv(scraped_data, 5000, 'ab', meet, runners)
